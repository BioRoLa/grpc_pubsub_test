...
int main() {
    ...
    core::Subscriber<config_msg::ConfigStamped> &sub = nh.subscribe<config_msg::ConfigStamped>("motor/config/reply", 1000, cb, 10);
    
    std::cout << "Config Node Test Subscriber Started. Listening on 'motor/config/reply'...\n";
